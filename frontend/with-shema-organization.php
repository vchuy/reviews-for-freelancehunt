<?php
            ...
            foreach ($json['data'] as $address) {
                ...
                <div itemscope="" itemtype="http://schema.org/Review"   class="clearfix hreview  review review-positive progect-id-<?php echo $address['id'] . "\n"; ?>">
                    <meta itemprop="datePublished" content="<?php echo date("Y.m.d", strtotime($address['attributes']['published_at'] . "\n")); ?>" />

                    <div itemprop="itemReviewed" itemscope itemtype="https://schema.org/Organization">
                        <meta itemprop="name" content="<?php echo get_option( 'name_company_huntrewievs' )   ?>"/>
                        <meta itemprop="address" content="<?php echo get_option( 'address_company_huntrewievs' )   ?> "/>
                        <meta itemprop="telephone" content="<?php echo get_option( 'telephone_company_huntrewievs' )   ?>" />
                    </div>
                    ...
                    <div class="col-lg-4 col-lg-push-8 col-sm-6 col-sm-push-6">
                        <div class="row">
                            <div itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating"  class="col-md-12 text-right" style="padding-top: 10px; padding-left: 0;">
...
<?php } ?></span></div>
                                ...
                                <?php if (!empty($address['attributes']['grades']['total'])) { ?>
                                    <div><span
                                                class="label label-review color-dark-gray"><?php echo esc_attr_e('Total', 'huntrewievs') ?></span>
                                        <span class="nowrap text-green">
<?php if (($address['attributes']['grades']['total'] . "\n") == 10) { ?>
    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
            class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
            class="fa fa-star"></i><i class="fa fa-star"></i>
<?php } elseif (($address['attributes']['grades']['total'] . "\n") == 9) { ?>
    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
            class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i
            class="fa fa-star"></i><i class="fa fa-star-o"></i>
<?php } elseif (($address['attributes']['grades']['total'] . "\n") == 8) { ?>
...
<?php }  ?>
                                        ...
                                        <span itemprop="ratingValue" class="hidden" style="display: none;">  <?php echo $address['attributes']['grades']['total'] . "\n"; ?> </span>
                    ...
                    <div class="col-lg-8 col-lg-pull-4 col-sm-6 col-sm-pull-6">
                        <p itemprop="reviewBody"  class="linkify-marker"><?php echo $address['attributes']['comment'] . "\n"; ?></p>
                        <p class="text-dark-gray profile-<?php echo $address['attributes']['from']['id'] . "\n"; ?>">
                            ...
                            <span  itemprop="author" itemscope="" itemtype="http://schema.org/Person" class="reviewer">

<span itemprop="name"  class="profile_id-<?php echo $address['attributes']['from']['id'] . "\n"; ?>"><?php echo $address['attributes']['from']['first_name'] . "\n";
